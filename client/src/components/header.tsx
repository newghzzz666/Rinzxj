                    ...
                    <Padding className="mx-4 mt-4">
                        <div className="w-full flex justify-between items-center">
                            ...
                            <div
                                ...
                                <div
                                    className="flex flex-row items-center bg-surface-light dark:bg-surface-dark backdrop-blur-md t-primary rounded-full px-2 shadow-xl shadow-light ring-1 ring-black/5 dark:ring-white/10">
                                    <Link aria-label={t('home')} href="/"
